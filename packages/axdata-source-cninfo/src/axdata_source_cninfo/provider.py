...
if TYPE_CHECKING:
    from .adapter import CninfoProviderAdapter


class CninfoProvider:
    """Provider for Cninfo announcement metadata."""
    ...
    ) -> CninfoProviderAdapter:
        from .adapter import CninfoProviderAdapter

        return CninfoProviderAdapter(options=options)
